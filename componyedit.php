		          ...
		          <div class="recent-sales">
						...
						<form method="post" enctype="multipart/form-data">
							<div class="content">
								...
								<span> Compony Address. : </span> <input type="text" name="mno" placeholder="Compony Address...">
								<span> Compony Contact No. : </span> <input type="text" name="ema" placeholder="Compony Contact No...">
								<span> Compony Email Id : </span> <input type="text" name="add" placeholder="Compony Email Id...">
								<span> User Type : </span>
								<select name="utype">
