		...
		<section class="home-section">
		      <nav>
		        <div class="sidebar-button">
		          <span class="dashboard">Edit Event</span>
		        </div>
		        ...
		        <div class="sales-boxes">
		          <div class="recent-sales">
						...
						<?php
							...
							echo "<table>";
							echo "<tr> <th> NAME </th> <th> MOBILE NO. </th> <th> EMAIL </th> <th> ADDRESS </th> <th> EVENT NAME </th> <th> EVENT LOCATION </th> <th> IMAGE </th> <th> EVENT DATE </th> <th> EVENT VENUE </th> <th> EDIT </th> <th> DELETE </th> </tr>";
							...
							while($row=mysqli_fetch_assoc($res)){
								...
								echo "<td> <a href='eventedit.php?id=$id'> EDIT </a> </td>";
								echo "<td> <a href='eventdelete.php?id=$id&image=$img1'> DELETE </a> </td> </tr>";
							}
