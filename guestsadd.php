		    ...
		    <div class="logo-details">
		      ...
		      <ul class="nav-links">
		        ...
		        <li>
			        ...
			        <li>
			          <a href="guestsadd.php" class="active">
			          	<i></i>
		        ...
		        <div class="sales-boxes">
		          <div class="recent-sales">
						...
						<form method="post">
							...
							<div class="content">
								<span> Guest Name : </span> <input type="text" name="gname" placeholder="Guest Name...">
								<span> Guest Post : </span> <input type="text" name="gpost" placeholder="Post Of Guest...">
								<span> Mobile No. : </span> <input type="text" name="gmno" placeholder="Mobile No...">
								<span> Email : </span> <input type="text" name="gemail" placeholder="Email Id...">
								<span> Address : </span> <input type="text" name="gadd" placeholder="Address...">
								
								<div class="btnclass">
									<input type="submit" name="check" value="Add Guest"> 
								</div>
							</div>
...
if(isset($_POST['check'])){
	...
	if(!empty($nm) && !empty($post) && !empty($mno) && !empty($email) && !empty($add)){
		...
		$query="INSERT INTO `GUEST_MST`(`GNAME`, `GPOST`, `GMONO`, `GEMAIL`, `GADD`) VALUES ('$nm','$post','$mno','$email','$add')";
