		    ...
		    <div class="logo-details">
		      ...
		      <ul class="nav-links">
		        ...
		        <li>
			        ...
			        <li>
			          <a href="locationedit.php" class="active">
			          	<i></i>
		        ...
		        <div class="sales-boxes">
		          <div class="recent-sales">
						...
						<?php
							...
							echo "<table border='1'>";
							echo "<tr> <th> Location Name </th> <th> Location Address </th> <th> Manager Name </th> <th> Manager Mobile No. </th> <th> Manager Email Id. </th> <th> Maximum Capasity </th> <th> EDIT </th> <th> DELETE </th> </tr>";

							$query="SELECT * FROM `LOC_MST`";
							...
							while($row=mysqli_fetch_assoc($res)){
								...
								echo "<td> <a href='editlocation.php?id=$id'> Edit </a> </td>";
								echo "<td> <a href='locationdelete.php?id=$id'> Delete </a> </td>";
								echo "</tr>";
							}
