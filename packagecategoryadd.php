			...
			<div class="sidebar">
			    <div class="logo-details">
		      	...
		      	<ul class="nav-links">
			        ...
			        <li>
			          <a href="packagecategoryadd.php" class="active">
			          	<i></i>
		        ...
		        <div class="sales-boxes">
		          <div class="recent-sales">
						...
						<form method="post" enctype="multipart/form-data">
							<div class="content">
								<span> Package Category : </span> <input type="text" name="category" placeholder="Package Category...">
								
								<div class="btnclass">
								<input type="submit" name="check" value="Add Category"> 
...
if(isset($_POST['check'])){
	...
	if(!empty($cate) && !empty($createdate)){
		...
		$query="INSERT INTO `PACKAGE_CATEGORY`(`CAT_NAME`, `CRE_DATE`) VALUES ('$cate','$createdate')";
