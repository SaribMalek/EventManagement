		          ...
		          <div class="recent-sales">
						...
						<h2> Package Category Edit/Remove  </h2>
							<?php
								...
								$query="SELECT * FROM `PACKAGE_CATEGORY` WHERE ID='$uid'";
							...
							<div class="content">
								<span> Package Category : </span> <input type="text" name="category" placeholder="Package Category..." value="<?php echo $catego; ?>">
								
								<div class="btnclass">
								<input type="submit" name="check" value="Update Category"> 
...
if(isset($_POST['check'])){
	...
	if(!empty($cate) && !empty($createdate)){

		include("connection.php");
		$query="UPDATE `PACKAGE_CATEGORY` SET `CAT_NAME`='$cate' WHERE `ID`='$uid'";
		$res=mysqli_query($con, $query);
		if($res==TRUE){
