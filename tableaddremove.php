			...
			<div class="sidebar">
			    <div class="logo-details">
		      	...
		      	<ul class="nav-links">
			        ...
			        <li>
			          <a href="tableaddremove.php" class="active">
			          	<i></i>
		          ...
		          <div class="recent-sales">
						...
						<form method="post" enctype="multipart/form-data">
							<div class="content">
								...
								<span> Total No Of Table : </span> <input type="text" name="tottab" id="tottable" placeholder="Total No Of Tables...">
								<span> Chairs With One Table : </span> <input type="text" name="chtab" id="chairtab" placeholder="Chairs With One Table...">
								<span> Total Chairs : </span> <input type="text" name="tchai" id="totchair" placeholder="Total No Chairs...">
								
								<div class="btnclass">
								<input type="submit" name="check" value="Add Table"> 
